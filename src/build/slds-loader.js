 ...
 * Asset URLs point to files under `public/slds/styles` so they resolve
 * consistently in local dev and GitHub Pages builds.
 *
...
const slds2CssUrl = new URL('slds/styles/slds2.cosmos.css', document.baseURI).href;
